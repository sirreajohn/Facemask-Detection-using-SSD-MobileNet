...
configs = config_util.get_configs_from_pipeline_file("models\my_ssd_mobnet\pipeline.config")
...
while True: 
    ...
    cv2.imshow('Face Mask Detections',  cv2.resize(image_np_with_detections, (800, 600)))
